...
namespace Template
{
    ...
    public class Mesh
    {
        ...
        public float cos(float theta) => (float)MathHelper.Cos(theta);
        public float sin(float theta) => (float)MathHelper.Sin(theta);
        public float tan(float theta) => (float)MathHelper.Tan(theta);
        ...
        public void Render(Shader shader, Matrix4 objectToScreen, Matrix4 objectToWorld, Texture texture, Vector3 AmbientLight, Vector3[] lightpos, Vector3[] colors, Vector3 camPos)
        {
            ...
            GL.Uniform1(shader.uniform_specularReflectiveness, reflectiveness);
            GL.Uniform1(shader.uniform_diffuseReflectiveness, difReflectiveness);
